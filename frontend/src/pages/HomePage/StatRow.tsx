  ...
  return (
    <div className="stats-row mt-0">
      <StatCard 
        ...
        color="bg-gradient-to-br from-[#6ee7b7] to-[var(--main-green-color)] text-white"
      ...
      <StatCard 
        ...
        value="20+" 
        color="bg-gradient-to-br from-[#9ca3af] to-[#1F2532] text-white"
        iconColor="#1F2532"
      ...
      <StatCard 
        ...
        color="bg-gradient-to-br from-[#fdba74] to-[var(--main-orange-color)] text-white"
