export default function BannerPromo() {
  return (
    <section className="card promo relative overflow-hidden h-full flex flex-col justify-center">
      ...
      <h2 className="w-full sm:w-2/3 leading-tight mb-4 relative z-10 text-xl sm:text-2xl">Join Now and Get Discount Voucher Up To 20%</h2>
      <p className="w-full sm:w-2/3 text-[13px] relative z-10">Become a membership to get more benefits! A 20% discount is currently running until the end of March</p>
    </section>
  );
}
