  ...
  return (
    <div className="page-stack">
      ...
      <div className="page-grid-2">
        ...
        <section className="card"><h3>Contest Rating 2,415</h3><div style={{ width: "100%", height: 160 }}><ResponsiveContainer><LineChart data={rating}><XAxis dataKey="m" /><YAxis /><Tooltip /><Line type="monotone" dataKey="r" stroke="var(--main-orange-color)" strokeWidth={3} /></LineChart></ResponsiveContainer></div></section>
      </div>
