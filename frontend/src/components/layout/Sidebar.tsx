...
interface SidebarContentProps {
  ...
  setShowAdminMenu: (v: boolean) => void;
  onNavClick: () => void;
}

function SidebarContent({ isAdmin, showAdminMenu, setShowAdminMenu, onNavClick }: SidebarContentProps) {
  return (
    <>
      ...
      <div className="side-nav">
        ...
        {isAdmin && (
          <div className="flex flex-col w-full">
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${showAdminMenu ? 'max-h-40 opacity-100 mt-2' : 'max-h-0 opacity-0 mt-0'}`}>
